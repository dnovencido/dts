<?php
  ...
  $receiving_offices_data = get_all_receiving_offices($filter, ['offset'=> $offset, 'total_records_per_page' => TOTAL_RECORDS_PER_PAGE]);
        ...
        <?php include 'layouts/_navbar.php'; ?>
          ...
          <section class="content-header">
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1>Manage Receiving Offices</h1>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Receiving Office</li>
                  </ol>
                </div>
              </div>
            </div><!-- /.container-fluid -->
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="menu mt-5 mb-3">
                    <a href="/receiving_offices/new" class="btn bg-gradient-success btn-md"><i class="fa-solid fa-plus"></i> New </a>
                  </div>
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Receiving Offices</h3>
                    </div>
                    <!-- /.card-header -->
                              ...
                              <?php foreach($receiving_offices as $key => $value ) { ?>
                                  <tr>
                                      ...
                                      <td class="action-buttons">
                                          <button data-url="/receiving_offices/view/<?= $value['id'] ?>" class="btn bg-gradient-info btn-sm view-modal"><i class="fa-solid fa-eye"></i></button>
                                          <a href="/receiving_offices/edit/<?= $value['id'] ?>" class="btn bg-gradient-primary btn-sm"><i class="fa-solid fa-pencil"></i></i></a>
                                          <a href="#" class="btn bg-gradient-danger btn-sm btn-delete" data-id="<?= $value['id'] ?>" data-url="/receiving_offices/delete"><i class="fa-solid fa-trash"></i></a>
                                      </td>
                                  </tr>
                              <?php } ?>
                            <?php } else { ?>
                                <td colspan="9">No receiving office(s) to display.</td>
                            <?php } ?>                
                          </tbody>
                        </table>
                      </div>
