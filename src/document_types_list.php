<?php
  ...
  $document_type_data = get_all_document_types($filter, ['offset'=> $offset, 'total_records_per_page' => TOTAL_RECORDS_PER_PAGE]);
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="menu mt-5 mb-3">
                    <a href="/document_types/new" class="btn bg-gradient-success btn-md"><i class="fa-solid fa-plus"></i> New </a>
                  </div>
                  <div class="card">
                              ...
                              <?php foreach($document_types as $key => $value ) { ?>
                                  <tr>
                                      ...
                                      <td class="action-buttons">
                                          ...
                                          <a href="/document_types/edit/<?= $value['id'] ?>" class="btn bg-gradient-primary btn-sm"><i class="fa-solid fa-pencil"></i></i></a>
                                          <a href="#" class="btn bg-gradient-danger btn-sm btn-delete" data-id="<?= $value['id'] ?>" data-url="/document_types/delete"><i class="fa-solid fa-trash"></i></a>
                                      </td>
                                  </tr>
                              <?php } ?>
                            <?php } else { ?>
                                <td colspan="9">No document type(s) to display.</td>
                            <?php } ?>                
                          </tbody>
                        </table>
                      </div>
