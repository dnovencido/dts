          ...
          <?php include 'layouts/_navbar.php'; ?>
            ...
            <section class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1>Manage Incoming Documents</h1>
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="menu mt-5 mb-3">
                      <a href="/documents/incoming/new?=incoming" class="btn bg-gradient-success btn-md"><i class="fa-solid fa-plus"></i> New </a>
                    </div>
                    <div class="card">
                              ...
                              <?php if(!empty($documents)) { ?>
                                <?php foreach($documents as $key => $value ) { ?>
                                    <tr>
                                        ...
                                        <td><?= date('M d, Y @ h:i a', strtotime($value['date_received'])) ?></td>
                                        <td class="action-buttons">
                                            <a href="/documents/incoming/view/<?= $value['id'] ?>" class="btn bg-gradient-info btn-sm"><i class="fa-solid fa-eye"></i></a>
                                            <a href="/documents/incoming/edit/<?= $value['id'] ?>" class="btn bg-gradient-primary btn-sm"><i class="fa-solid fa-pencil"></i></i></a>
